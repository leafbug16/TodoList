    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<c:url value='/board/read?bno=${board.bno }&mode=myPost'/>">${board.title }</a></td>
                <td>${board.writer }</td>
	...
	<nav>
	  <ul>
	    ...
	    <c:forEach var="i" begin="${ph.beginPage }" end="${ph.endPage }">
	    	<li ${ph.page==i? 'active':'' }"><a href="<c:url value='/board/listMyPost?page=${i }&pageSize=${ph.pageSize }' />">${i }</a></li>
	    </c:forEach>
